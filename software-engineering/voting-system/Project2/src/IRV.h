...
class IRV : public ElectionObject {
    ...
    **/
    ...
    /**
    * @brief Sets the exhausted field.
    * 
    * @param exhaust an integer vector.
    **/
    void setExhausted(std::vector<int> exhaust);

    /**
    * @brief Sets the exhausted totalVotes field (for testing purposes).
    * 
    * @param total an integer representing total number of votes.
    **/
    void setTotal(int total);

    /**
    * @brief Gets the exhausted field.
    * 
    * @return The exhausted field.
    **/
    std::vector<int> getExhausted();

    /**
    * @brief Gets the total field.
    * 
    * @return The totalVotes field.
    **/
    int getTotal();
