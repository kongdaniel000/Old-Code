...
shapes toShape(std::vector<std::string> collect)
{
    ...
    for(int i = 0; i < collect.size(); i++)
    {
        ...
        {
            // Commented out code is in case textured shapes don't need intrinsic definitions anymore
            // if(textureIndex == 0)
            // {
            ...
            // else
            // {
            //     lit.specularH.r = std::stod(collect.at(i+1));
            //     lit.specularH.g = std::stod(collect.at(i+2));
            //     lit.specularH.b = std::stod(collect.at(i+3));

            //     lit.weight.ka = std::stod(collect.at(i+4));
            //     lit.weight.kd = std::stod(collect.at(i+5));
            //     lit.weight.ks = std::stod(collect.at(i+6));

            //     lit.exponent = std::stoi(collect.at(i+7));
            // }
        }
